...
#'
#' Important note: the function requires all input files (.txt list files, .csv data files and metadata directory containing .xml metadata files) to be located in the same directory.
#'
...
#' @param main.object.structure.nm a string indicating the name used in the main IdentifyPrimaryObjects module to define the main object in the CellProfiler pipeline. Default is "cell_body".
